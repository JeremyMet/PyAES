mult_0x02_array = [0x00,0x02,0x04,0x06,0x08,0x0a,0x0c,0x0e,0x10,0x12,0x14,0x16,0x18,0x1a,0x1c,0x1e,
...
mult_0x03_array = [0x00,0x03,0x06,0x05,0x0c,0x0f,0x0a,0x09,0x18,0x1b,0x1e,0x1d,0x14,0x17,0x12,0x11,
...
T0 = [0xa56363c6, 0x847c7cf8,  0x997777ee,  0x8d7b7bf6,
...
T1 = [0x6363c6a5, 0x7c7cf884,  0x7777ee99,  0x7b7bf68d,
...
T2 = [0x63c6a563, 0x7cf8847c,  0x77ee9977,  0x7bf68d7b,
...
T3 = [0xc6a56363, 0xf8847c7c,  0xee997777,  0xf68d7b7b,
...
mult_0x02 = lambda x : mult_0x02_array[x];
mult_0x03 = lambda x : mult_0x03_array[x];
apply_tboxes = lambda c0, c1, c2, c3 : T0[c0 & 0xFF] ^ T1[c1 & 0xFF] ^ T2[c2 & 0xFF] ^ T3[c3 & 0xFF];
sb = lambda x : SBOX[x&0xFF];
